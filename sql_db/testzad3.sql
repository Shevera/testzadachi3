...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 27 2016 г., 11:22
...
--
CREATE DATABASE IF NOT EXISTS `testzad3` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `testzad3`;
...
(107, 'Vasil', 'screppi@gmail.com', 'dghdh', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.87 Safa', '2016-04-27', 'testimage.jpg');
